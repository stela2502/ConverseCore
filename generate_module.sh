...
if bind_paths ~= "-B "..base.."/models:/app/ollama" then
    bind_paths = "-B "..bind_paths
end

-- this happens at load
execute{cmd="singularity run --nv "-B "..base.."/models:/app/ollama "..bind_paths.." ".. base.. "/${IMAGE_NAME}_v".. version ..".sif",modeA={"load"}}
